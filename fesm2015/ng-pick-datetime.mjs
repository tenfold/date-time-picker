...
OwlTimerBoxComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: OwlTimerBoxComponent, selectors: [["owl-date-time-timer-box"]], hostVars: 2, hostBindings: function OwlTimerBoxComponent_HostBindings(rf, ctx) {
    ...
    }, directives: [i4.NgIf], pipes: [NumberFixedLenPipe], styles: [""], changeDetection: 0 });
(function () {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(OwlDateTimeInlineComponent, [{
            ...
            args: [{ selector: 'owl-date-time-inline', host: {
                    ...
                    }, changeDetection: ChangeDetectionStrategy.OnPush, preserveWhitespaces: false, providers: [OWL_DATETIME_VALUE_ACCESSOR$1], template: "<owl-date-time-container></owl-date-time-container>", styles: [""] }]
        }], function () {
        return [{ type: i0.ChangeDetectorRef }, { type: DateTimeAdapter, decorators: [{
                        type: Optional
                    }] }, { type: undefined, decorators: [{
...
OwlDialogService.ɵfac = function OwlDialogService_Factory(t) { return new (t || OwlDialogService)(i0.ɵɵinject(i1$1.Overlay), i0.ɵɵinject(i0.Injector), i0.ɵɵinject(i4.Location, 8), i0.ɵɵinject(OWL_DIALOG_SCROLL_STRATEGY), i0.ɵɵinject(OWL_DIALOG_DEFAULT_OPTIONS, 8), i0.ɵɵinject(OwlDialogService, 12), i0.ɵɵinject(i1$1.OverlayContainer)); };
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(OwlDialogService, [{
        ...
        return [{ type: i1$1.Overlay }, { type: i0.Injector }, { type: i4.Location, decorators: [{
                        type: Optional
                    }] }, { type: undefined, decorators: [{
                        type: Inject,
